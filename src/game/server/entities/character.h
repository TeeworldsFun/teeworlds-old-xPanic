...
public:
	...
	void SwitchShield();
	void SwitchHeartShield(bool Switch);
	void SwitchSlowBomb(bool Switch);
	...
	void ExperienceAdd(int Exp, int ClientID, bool Silent = false);
...
public:
	...
	void IncreaseArmorwall(int Seconds) { m_ShieldTick += Seconds * Server()->TickSpeed(); };
