...
int CGameWorld::FindCharacters1(vec2 Pos0, vec2 Pos1, float Radius, CCharacter **ppChars, int Max)
{
	int Num = 0;
	CCharacter *pCh = (CCharacter *)FindFirst(CGameWorld::ENTTYPE_CHARACTER);
