...
// server
MACRO_CONFIG_INT(SvExpFactor, sv_exp_factor, 1, 0, 1000, CFGFLAG_SERVER, "Player exp factor")
MACRO_CONFIG_INT(SvExpFactorVIP, sv_exp_factor_vip, 2, 0, 1000, CFGFLAG_SERVER, "VIP player exp factor")
MACRO_CONFIG_INT(SvExpFactorNovice, sv_exp_factor_novice, 2, 0, 1000, CFGFLAG_SERVER, "Novice player exp factor")

MACRO_CONFIG_INT(SvMoneyFactor, sv_money_factor, 1, 0, 1000, CFGFLAG_SERVER, "Player money factor")
MACRO_CONFIG_INT(SvMoneyFactorVIP, sv_money_factor_vip, 2, 0, 1000, CFGFLAG_SERVER, "VIP player money factor")
MACRO_CONFIG_INT(SvMoneyFactorNovice, sv_money_factor_novice, 2, 0, 1000, CFGFLAG_SERVER, "Novice player money factor")
